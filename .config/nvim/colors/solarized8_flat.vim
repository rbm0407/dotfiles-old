...
if &background ==# 'dark'
  ...
  if s:termtrans
    ...
    hi Normal guifg=NONE guibg=#002b36 gui=NONE cterm=NONE
  ...
  if s:termtrans
    ...
    hi Normal guifg=NONE guibg=#fdf6e3 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    if s:termtrans
      ...
      hi Terminal ctermfg=NONE ctermbg=235 cterm=NONE
